...
import Storage, { type Domain } from "../Background/storage";
...
const PopupContext = React.createContext<IPopupContextProps | undefined>(
	undefined,
);
...
function PopupProvider({ children }: IPopupProviderProps): React.ReactElement {
	...
	const [domainSelected, setDomainSelected] = React.useState<Domain | null>(
		null,
	);
